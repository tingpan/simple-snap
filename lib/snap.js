...
Snap = (function(superClass) {
  ...
  Snap.prototype._checkHori = function(obj) {
    var $helper, $stopObj, _forceHori, _lineAxis, offsetHori, p1, p2, startPoint, targetBot, targetTop, width;
    ...
    $.each($(obj.dragging).siblings("." + $(obj.dragging).attr('class')), (function(_this) {
      return function(index, ele) {
        var $ele, distance1, distance2, eleBot, eleTop, forceHori, lineAxis;
        forceHori = null;
        lineAxis = null;
        $ele = $(ele);
